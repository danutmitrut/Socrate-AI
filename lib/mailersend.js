...
/**
 * Send subscription canceled email (access remains until end date)
 */
export async function sendSubscriptionCanceledEmail(email, endDate) {
  if (!process.env.MAILERSEND_API_KEY) {
    console.warn('Mailersend API key not configured');
    return { success: false, error: 'Mailersend not configured' };
  }
  ...
  try {
    const formattedDate = new Date(endDate).toLocaleDateString('ro-RO', {
      year: 'numeric',
      month: 'long',
      day: 'numeric'
    });
    ...
    const response = await fetch('https://api.mailersend.com/v1/email', {
      ...
      body: JSON.stringify({
        ...
        subject: 'Confirmare Anulare Abonament',
        html: `
          <!DOCTYPE html>
          <html>
          <head>
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                <h2 style="color: #2d3748; font-size: 20px;">Abonament Anulat</h2>

                <p>Salut,</p>

                <p>Îți confirmăm că abonamentul tău a fost anulat, așa cum ai solicitat.</p>

                <div class="info-box">
                  <p style="margin: 0;"><strong>Mai ai acces până la:</strong></p>
                  <p style="margin: 8px 0 0 0; font-weight: bold; font-size: 18px;">${formattedDate}</p>
                </div>

                <p>Până la acea dată, te poți bucura în continuare de toate beneficiile contului Premium.</p>
                
                <p>Dacă te răzgândești, poți reactiva abonamentul oricând din contul tău.</p>

                <div style="text-align: center; margin: 30px 0;">
                  <a href="https://socrate-ai-8teu.vercel.app" class="button">Mergi la Contul Meu</a>
                </div>
              </div>

              <div class="footer">
                <p>© ${new Date().getFullYear()} Socrate AI. Toate drepturile rezervate.</p>
                <p>Sperăm să te revedem curând!</p>
              </div>
            </div>
          </body>
          </html>
...
Îți confirmăm că abonamentul tău a fost anulat.

Mai ai acces până la: ${formattedDate}

Până la acea dată, te poți bucura în continuare de toate beneficiile contului Premium.

Dacă te răzgândești, poți reactiva abonamentul oricând din contul tău: https://socrate-ai-8teu.vercel.app
...
/**
 * Send subscription expired email (downgrade to dormant)
 */
        ...
        html: `
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                <h2 style="color: #2d3748; font-size: 20px;">Abonamentul a Expirat</h2>

                <p>Salut,</p>

                <p>Perioada abonamentului tău s-a încheiat, iar contul a trecut în modul "Dormant".</p>

                <div class="info-box">
                  <p style="margin: 0;"><strong>Ce înseamnă asta?</strong></p>
                  <ul style="margin: 8px 0 0 0; padding-left: 20px;">
                    <li>Poți vedea istoricul conversațiilor tale</li>
                    <li>Nu mai poți trimite mesaje noi</li>
                  </ul>
                </div>

                <p>Pentru a continua dialogul cu Socrate AI și a debloca accesul nelimitat, te invităm să reînnoiești abonamentul.</p>

                <div style="text-align: center; margin: 30px 0;">
                  <a href="https://socrate-ai-8teu.vercel.app" class="button">Reînnoiește Abonamentul</a>
                </div>
              </div>
...
Perioada abonamentului tău s-a încheiat, iar contul a trecut în modul "Dormant".

Ce înseamnă asta?
- Poți vedea istoricul conversațiilor tale
- Nu mai poți trimite mesaje noi

Pentru a continua dialogul, te invităm să reînnoiești abonamentul: https://socrate-ai-8teu.vercel.app
